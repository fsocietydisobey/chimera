...
Wraps Google's `gemini` CLI. Migrated from chimera-legacy `cli/runners.py`.
...
DEFAULT_CMD = os.environ.get("CHIMERA_GEMINI_CMD", "gemini")
DEFAULT_MODEL = os.environ.get("CHIMERA_GEMINI_MODEL", "gemini-2.5-pro")
        ...
        **_: object,
        ...
        if not self.is_available():
            raise RuntimeError(
                ...
                "Set CHIMERA_GEMINI_CMD or install: npm install -g @google/gemini-cli"
            )
