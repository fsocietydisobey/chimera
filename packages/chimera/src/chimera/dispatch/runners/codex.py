...
Wraps the `codex` binary. New for chimera v2 — legacy didn't have a Codex
...
DEFAULT_CMD = os.environ.get("CHIMERA_CODEX_CMD", "codex")
DEFAULT_MODEL = os.environ.get("CHIMERA_CODEX_MODEL", "gpt-5-codex")
        ...
        **_: object,
        ...
        if not self.is_available():
            raise RuntimeError(
                ...
                "Set CHIMERA_CODEX_CMD or install: npm install -g @openai/codex"
            )
