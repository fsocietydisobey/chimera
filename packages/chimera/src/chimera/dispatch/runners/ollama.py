...
terminal AI subscription, chimera routes trivial tasks here and reserves
...
DEFAULT_CMD = os.environ.get("CHIMERA_OLLAMA_CMD", "ollama")
DEFAULT_MODEL = os.environ.get("CHIMERA_OLLAMA_MODEL", "llama3.3:70b")
        ...
        **_: object,
        ...
        if not self.is_available():
            raise RuntimeError(
                ...
                "Set CHIMERA_OLLAMA_CMD or install: https://ollama.com/download"
            )
