...
from chimera.config import load_routing_table
...
_CLASSIFIER_PROMPT = """You are the chimera AMR (Automatic Model Router) classifier.
...
tasks is the failure mode chimera exists to prevent."""
