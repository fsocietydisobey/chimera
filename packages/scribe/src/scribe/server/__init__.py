"""Scribe's FastMCP server — exposes meeting tools to khimaira.
...
see `mcp__khimaira__scribe_process`, `mcp__khimaira__scribe_record_start`,
etc., via one MCP connection.

Standalone `scribe serve` is also possible — same tools, no prefix —
